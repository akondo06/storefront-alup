	...
	class Storefront {
		...
		public function scripts() {
			...
			$google_fonts = apply_filters( 'storefront_google_font_families', array(
				...
				'lato' => 'Lato:400,300,300italic,400italic,700,700italic,900,900italic',
			) );
		...
		public function print_embed_styles() {
			...
			wp_enqueue_style( 'lato', '//fonts.googleapis.com/css?family=Lato:400,300,300italic,400italic,700,700italic,900,900italic' );
