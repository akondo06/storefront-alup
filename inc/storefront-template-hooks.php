...
add_action( 'storefront_before_header_inner', 'storefront_product_search',         40 );
add_action( 'storefront_before_header_inner', 'storefront_header_cart',            40 );
add_action( 'storefront_before_header_inner', 'storefront_secondary_navigation',   40 );
...
add_action( 'storefront_footer', 'storefront_footer_navigation', 20 );
